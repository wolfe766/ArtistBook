...
class SearchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create search" do
    assert_difference('Search.count') do
      post searches_url, params: { search: { business_id: @search.business_id, genre: @search.genre } }
    end
  ...
  test "should update search" do
    patch search_url(@search), params: { search: { business_id: @search.business_id, genre: @search.genre } }
