...
class BandsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create band" do
    assert_difference('Band.count') do
      post bands_url, params: { band: { address,: @band.address,, band_name,: @band.band_name,, email: @band.email, genre,: @band.genre,, phone,: @band.phone, } }
    end
  ...
  test "should update band" do
    patch band_url(@band), params: { band: { address,: @band.address,, band_name,: @band.band_name,, email: @band.email, genre,: @band.genre,, phone,: @band.phone, } }
